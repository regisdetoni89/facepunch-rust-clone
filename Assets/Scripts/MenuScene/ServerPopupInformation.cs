...
public class ServerPopupInformation : MonoBehaviour
{
    ...
    public void SetInformation(string serverName, string serverIP, string serverMap, int currentPlayers, int maxPlayers, string wipeAgo)
    {
        transform.Find("ServerName").GetComponent<TMPro.TextMeshProUGUI>().text = serverName;
        transform.Find("ServerIP").GetComponent<TMPro.TextMeshProUGUI>().text = serverIP;
